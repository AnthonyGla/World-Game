              ...
              <div class="col-lg-10 col-12 big_bloc_comment">
                <div class="d-flex flex-column w-100 comment_news pair">
                  <div class="comment_details pair_txt">
                      ...
                      <?php } ?>
                      <p>Posté par <?php echo $comment->username.' '.$comment->date; ?></p>
                  </div>
              ...
              <div class="col-lg-9 col-12 big_bloc_comment">
                ...
                <div class="w-100 comment_news">
                  <div class="comment_details">
                      ...
                      <?php } ?>
                      <p>Posté par <span><?php echo $comment->username.'</span> '.$comment->date; ?></p>
...
<img src="https://vignette.wikia.nocookie.net/leagueoflegends/images/8/82/Go_Team%21_Emote.png/revision/latest?cb=20180601212712">
